...
class Ui_onlineFriendsWidget(object):
    def setupUi(self, onlineFriendsWidget):
        ...
        self.reply_icon.setPixmap(QPixmap(u"../../../assets/images/icon_arrow.png"))
...
"min-height: 24;\n"
"max-height:24;")
        self.inputBackground.setPixmap(QPixmap(u"../../../assets/images/Rectangle 25.png"))
...
"")
        ...
        self.circle.setPixmap(QPixmap(u"../../../assets/images/greenCircle.png"))
